...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'project_end_month': ('django.db.models.fields.CharField', [], {'default': "'January'", 'max_length': '9'}),
            'project_end_year': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '4'}),
            'project_start_month': ('django.db.models.fields.CharField', [], {'default': "'January'", 'max_length': '9'}),
            'project_start_year': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '4'}),
